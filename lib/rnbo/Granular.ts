...
class Granular extends BaseSynth {
    parameters: string[] = getParameters('granular')
    ...
    constructor(urls: string[]) {
        ...
        this.parameters = getParameters('granular')
        this.init(urls)
     ...
     */
    snap(value: number = 0, time: number): void {
        this.messageDevice('snap', value, time)
    }
     ...
     */
    rate(value: number = 1, time: number): void {
        this.messageDevice('rate', value, time)
    }
     ...
     * @param value - playback rate, > 0 is forward, < 0 is reverse. 1 is normal speed, 2 is double speed, etc.
     */
    _rate(value: number = 1, time: number): void {
        this.messageDevice('_rate', value, time)
    }
     ...
     */
    grainrate(value: number = 16, time: number): void {
        this.messageDevice('grainrate', value, time)
    }
     ...
     * @param value - grain rate, number of grains per cycle or canvas
     */
    _grainrate(value: number = 16, time: number): void {
        this.messageDevice('_grainrate', value, time)
    }
     ...
     */
    grainsize(value: number = 0.125, time: number): void {
        this.messageDevice('grainsize', value, time)
    }
     ...
     * @param value - grain size, length of grain in beats
     */
    _grainsize(value: number = 0.125, time: number): void {
        this.messageDevice('_grainsize', value, time)
    }
     ...
     */
    grainslope(value: number = 0.01, time: number): void {
        this.messageDevice('grainslope', value, time)
    }
     ...
     * @param value - grain slope, attack of grain, 0 - 1
     */
    _grainslope(value: number = 0.01, time: number): void {
        this.messageDevice('_grainslope', value, time)
    }
     ...
     */
    grainpan(value: number = 0.2, time: number): void {
        this.messageDevice('grainpan', value, time)
    }
     ...
     * @param value - grain pan, amount of randomess in grain panning, 0 - 1
     */
    _grainpan(value: number = 0.2, time: number): void {
        this.messageDevice('_grainpan', value, time)
    }
     ...
     */
    direction(value: number = 1, time: number): void {
        this.messageDevice('direction', value, time)
    }
     ...
     * @param value - playback direction, 1 = forward, -1 = backward
     */
    _direction(value: number = 1, time: number): void {
        this.messageDevice('_direction', value, time)
    }
     ...
     */
    begin(value: number = 0, time: number): void {
        this.messageDevice('begin', value, time)
    }
     ...
     */
    end(value: number = 1, time: number): void {
        this.messageDevice('end', value, time)
    }
     ...
     */
    loop(value: number = 0, time: number): void {
        this.messageDevice('loop', value, time)
    }
     ...
     * @hidden
     */
    bpm(value: number = 120, time: number): void {
        this.messageDevice('bpm', value, time)
    }
