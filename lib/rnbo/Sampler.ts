...
class Sampler extends BaseSynth {
    parameters: string[] = getParameters('sampler')
    ...
    constructor(urls: string[]) {
        ...
        this.parameters = getParameters('sampler')
        this.init(urls)
    ...
    */
     ...
     */
    loopsize(value: number = 1, time: number): void {
        this.messageDevice('loopsize', value, time)
    }
     ...
     * @param value - loop size, 0 - 1
     */
    _loopsize(value: number = 1, time: number): void {
        this.messageDevice('_loopsize', value, time)
    }
     ...
     */
    oneshot(value: number = 0, time: number): void {
        this.messageDevice('oneshot', value, time)
    }
