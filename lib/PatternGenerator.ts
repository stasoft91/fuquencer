/**
 * File: PatternGenerator.ts
 * Taken from Tone.js 14.7.77 (https://github.com/Tonejs/Tone.js)
 */
...
/**
 * Randomly go through all the values once before choosing a new random order
 */
 ...
 */
export function* PatternGenerator(numValues: number, pattern: PatternName = "up"): Iterator<number> {
	// safeguards
